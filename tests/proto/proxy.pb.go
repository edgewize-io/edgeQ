...
const file_proxy_proto_rawDesc = "" +
	...
	"\vproxy.proto\"%\n" +
	"\tDataChunk\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent2C\n" +
	"\x0eBackendService\x121\n" +
...
var file_proxy_proto_goTypes = []any{
	(*DataChunk)(nil), // 0: DataChunk
}
var file_proxy_proto_depIdxs = []int32{
	0, // 0: BackendService.BidirectionalStream:input_type -> DataChunk
	0, // 1: BackendService.BidirectionalStream:output_type -> DataChunk
