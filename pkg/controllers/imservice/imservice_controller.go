...
func (r *Reconciler) reportServiceGroup(ctx context.Context, obj client.Object) (targetRequests []reconcile.Request) {
	...
	if err != nil {
		klog.Errorf("failed to get deployment %s/%s", obj.GetNamespace(), obj.GetName())
		return
	}
...
func (r *Reconciler) doReconcile(ctx context.Context, instance *apisappsv1alpha1.InferModelService) (ctrl.Result, error) {
	//serverDeploy := &v1.Deployment{}
	//if err := r.Get(ctx, types.NamespacedName{Name: instance.GetName(), Namespace: instance.GetNamespace()}, serverDeploy); err != nil {
	//	return ctrl.Result{}, client.IgnoreNotFound(err)
	//}
