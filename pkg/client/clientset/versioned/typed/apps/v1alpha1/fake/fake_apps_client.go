...
import (
	v1alpha1 "github.com/edgewize/edgeQ/pkg/client/clientset/versioned/typed/apps/v1alpha1"
...
func (c *FakeAppsV1alpha1) InferModelDeployments(namespace string) v1alpha1.InferModelDeploymentInterface {
	return newFakeInferModelDeployments(c, namespace)
}

func (c *FakeAppsV1alpha1) InferModelServices(namespace string) v1alpha1.InferModelServiceInterface {
	return newFakeInferModelServices(c, namespace)
}

func (c *FakeAppsV1alpha1) InferModelTemplates() v1alpha1.InferModelTemplateInterface {
	return newFakeInferModelTemplates(c)
}

func (c *FakeAppsV1alpha1) InferModelTemplateVersions() v1alpha1.InferModelTemplateVersionInterface {
	return newFakeInferModelTemplateVersions(c)
}
