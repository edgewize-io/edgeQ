...
var infermodeldeploymentsResource = v1alpha1.SchemeGroupVersion.WithResource("infermodeldeployments")

var infermodeldeploymentsKind = v1alpha1.SchemeGroupVersion.WithKind("InferModelDeployment")
