...
import (
	...
	"github.com/edgewize/edgeQ/pkg/client/clientset/versioned/scheme"
...
func (c *AppsV1alpha1Client) InferModelServices(namespace string) InferModelServiceInterface {
	return newInferModelServices(c, namespace)
}
