...
func (d *deployOperator) ListRunningInferModelServers(ctx context.Context, nodegroup string) (*ksappsv1alpha1.RunningInferModelServers, error) {
	...
	resourceSelector := labels.NewSelector()
	...
	resourceSelector = resourceSelector.Add(*requireTemplate, *requireTemplateVersion, *requireDeployment, *requireNodeGroup)
